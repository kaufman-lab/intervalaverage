...
exposure_dataset
```
Note that the above intervals are stored as a column for the start of the interval and a column for the end of the interval.  For the purpose of this package, intervals are ALWAYS treated as inclusive and the variables storing interval starts and ends must be discrete (e.g., class integer or IDate).
