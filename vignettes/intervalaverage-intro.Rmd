...
exposure_dataset3 <- rbindlist(
  lapply(1:2000, function(id) {
    data.table(
      location_id = id,
      start = seq(as.IDate("2000-01-01"), by = 7, length = 1000),
      end = seq(as.IDate("2000-01-07"), by = 7, length = 1000),
      pm25 = rnorm(4, mean = 15),
      no2 = rnorm(4, mean = 25)
    )
  })
...
averaging_periods3 <- data.table(location_id=1:2000,
                                 start=sample(
                                   seq(as.IDate("2000-01-01"),as.IDate("2019-12-31"),by=1),
                                   2000
                                 )
)
